...
contract TorNFT is ERC721URIStorage, Ownable {
    ...
    constructor()  ERC721("hsntawanaNft", "TOR") {}

    // Create a function to mint/create the NFT
    // receiver takes a type of address. This is the wallet address of the user that 
    // should receive the NFT minted using the smart contract
